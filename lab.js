...
let brittName = 'Brittani';
let amyName = 'Amy';

if (brittanisAge > amysAge) {
  console.log(`${brittName} is older`);
} else if (brittanisAge < amysAge) {
  console.log(`${amyName} is older`);
} else {
  console.log(`${brittName} and ${amyName} are the same age`);
}
...
if (temperature >= 80 && rain === true) {
  ...
  console.log('Wear a long sleeve');
} else {
...
console.log(`In problem 9 changeMyMind is set to ${changeMyMind}`);
...
console.log(`In problem 10 changeMyMind is set to ${changeMyMind}`)
